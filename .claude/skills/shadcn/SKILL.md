---
name: shadcn
description: MANDATORY UI PROTOCOL - Use this skill for ALL frontend, React, and UI development tasks. Triggers whenever the user asks to 'build,' 'style,' 'create,' 'fix,' or 'edit' any visual interface, component, or page. This skill enforces the shadcn/ui design system, component ownership, and Tailwind v4 CSS-First rules. DO NOT write generic React UI without this skill active.
